...
- [**`latest`**](https://hub.docker.com/repository/docker/registryhj/slim/tags?name=latest), [**`trixie`**](https://hub.docker.com/repository/docker/registryhj/slim/tags?name=trixie) - Debian 13 Trixie (Latest)
- [**`bookworm`**](https://hub.docker.com/repository/docker/registryhj/slim/tags?name=bookworm) - Debian 12 Bookworm
- [**`bullseye`**](https://hub.docker.com/repository/docker/registryhj/slim/tags?name=bullseye) - Debian 11 Bullseye (LTS)
